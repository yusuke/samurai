...
//        history.enableCleaningOrphans();
    ...
    void testValidation() {
        ...
        File file1 = new File(base + "src/main/resources/samurai/swing/images/close_hover.gif");
        File file2 = new File(base + "src/main/resources/samurai/swing/images/close_push.gif");
        File file3 = new File(base + "src/main/resources/samurai/swing/images/close.gif");
        ...
        File file5 = new File(base + "src/main/resources/samurai/util/default.properties");
        history.open(file1);
        history.open(file2);
